...
namespace AdishimBotApp.Models
{
    public static class Alfabet
    {
        ...
        public static Letter[] Letters =
        {
            ...
            new Letter(10, new int[]{1576 }, "Б", "б", "B", "b", "ﺏ", "ﺑ", "ﺒ", "ﺐ", true, true, true, new int[]{ 1576 }),
            new Letter(11, new int[]{1739 }, "В", "в", "W", "w", "ﯞ", "ﯞ", "ﯟ", "ﯟ", false, false, true, new int[]{1739}),
            ...
            new Letter(14, new int[]{1574, 1744 }, "Е", "е", "Ë", "ë", "ﺋﯥ", "ﺋﯧ", "ﯧ", "ﯥ", true, true, true, new int[]{ 1574, 1744 }), 
